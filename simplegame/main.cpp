...
int main(int argc, char** argv) {
	...
	GameLib::Actor player2(new GameLib::NoInputComponent(),
                          new GameLib::SimpleActorComponent(),
                          new GameLib::ColliderComponent(),
                          new GameLib::SimpleGraphicsComponent());
    player2.speed = (float)graphics.getTileSizeX();
    player2.position.x = 47.0f / (float)graphics.getTileSizeX();
    player2.position.y = 51.0f / (float)graphics.getTileSizeY();
    player2.spriteId = 30;
    world.actors.push_back(&player2);
	
    /*	 GameLib::Actor collPlayer1(new GameLib::SimpleInputComponent(),
								new GameLib::SimpleActorComponent(),
								new GameLib::ColliderComponent(),
								new GameLib::SimpleGraphicsComponent());
    world.actors.push_back(&collPlayer1);
    collPlayer1.speed = (float)graphics.getTileSizeX();
    collPlayer1.position.x = graphics.getCenterX() / (float)graphics.getTileSizeX();
    collPlayer1.position.y = graphics.getCenterY() / (float)graphics.getTileSizeY();
    collPlayer1.spriteId = 300;
    ...
    world.actors.push_back(&randomPlayer2);
    randomPlayer2.position.x = graphics.getCenterX() / (float)graphics.getTileSizeX();
    randomPlayer2.position.y = graphics.getCenterY() / (float)graphics.getTileSizeY();
    randomPlayer2.spriteId = 1300;
